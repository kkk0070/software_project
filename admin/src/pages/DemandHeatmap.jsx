    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
        ...
        <div className="bg-gray-100 rounded-lg h-96 overflow-hidden">
          <MapComponent
            heatmapData={demandAreas.map((area) => ({
              lat: parseFloat(area.lat || 11.0168),
              lng: parseFloat(area.lng || 76.9558),
              weight: parseFloat(area.demand_count || 1)
            }))}
          />
        </div>
      </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-3 gap-2 text-sm">
                      <div>
                        ...
                        <p className={`font-semibold ${area.gap === 'High' ? 'text-red-600' :
