...
export const initializeKeyManagement = async () => {
  try {
    ...
    if (error.message && (
      ...
      console.log('[INFO]  Encryption keys table not yet created');
