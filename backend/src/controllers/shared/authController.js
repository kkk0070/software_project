...
const fileFilter = (req, file, cb) => {
  ...
  // Also check extension (as additional security layer)
...
export const signup = async (req, res) => {
  try {
    ...
    console.log('\n🔐 Password Hashing Details (User Registration):');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log(`👤 User Email: ${email}`);
    console.log(`📝 Algorithm: ${algorithm} (bcrypt)`);
    console.log(`🔢 Cost Factor: ${costFactor} rounds (2^${costFactor} = ${Math.pow(2, parseInt(costFactor))} iterations)`);
    console.log(`🧂 Salt (22 chars): ${salt}`);
    console.log(`#️⃣  Hash (31 chars): ${hash}`);
